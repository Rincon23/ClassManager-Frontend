  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#0f172a] text-white px-6">
      ...
      <div className="flex flex-col gap-8 max-w-5xl w-full">
        <Card title="Criar" text="Adicione um novo professor." href="/professores/criar" />
        <Card title="Listar" text="Veja todos os professores cadastrados." href="/professores/listar" />
        <Card title="Atualizar" text="Edite informações de um professor existente." href="/professores/atualizar" />
        <Card title="Excluir" text="Remova um professor do sistema." href="/professores/deletar" />
      </div>
    </div>
  );
}
